...
#define _DIST_MIN 90.0   // minimum distance to be measured (unit: mm)
#define _DIST_MAX 180.0   // maximum distance to be measured (unit: mm)
...
void loop() {
  ...
  else
  {
    ...
    float percentAngle = _DUTY_MAX - _DUTY_MIN;
    int angle = _DUTY_MIN + (int)(percentAngle * ratio);
